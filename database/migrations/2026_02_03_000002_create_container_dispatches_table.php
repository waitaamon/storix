...
return new class extends Migration
{
    ...
    {
        $tableName = (string) config('storix.tables.dispatches', 'container_dispatches');
        ...
        Schema::create($tableName, function (Blueprint $table) use ($customerTable, $userTable): void {
            ...
            $table->string('delivery_note_code')->index();
    ...
    {
        Schema::dropIfExists((string) config('storix.tables.dispatches', 'container_dispatches'));
    }
};
