...
return new class extends Migration
{
    ...
    {
        $tableName = (string) config('container-movement.tables.dispatches', 'container_dispatches');
        ...
        Schema::create($tableName, function (Blueprint $table) use ($customerTable, $userTable): void {
            ...
            $table->string('sale_order_code')->index();
    ...
    {
        Schema::dropIfExists((string) config('container-movement.tables.dispatches', 'container_dispatches'));
    }
};
