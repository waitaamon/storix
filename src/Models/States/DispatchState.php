...
use Storix\Models\Transitions\DispatchToVoidedTransition;

/**
 * @extends State<Dispatch>
 */
abstract class DispatchState extends State
{
    ...
    final public static function config(): StateConfig
    {
        return parent::config()
            ...
            ->allowTransition(from: DispatchDraftState::class, to: DispatchVoidedState::class, transition: DispatchToVoidedTransition::class)
            ->allowTransition(from: DispatchApprovedState::class, to: DispatchVoidedState::class, transition: DispatchToVoidedTransition::class);
    }
}
